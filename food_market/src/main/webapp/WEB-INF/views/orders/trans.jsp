...
// {
// if($('post_num').value == "예)1234567890" || $('post_num').value == "11자리 숫자만 입력" || $('post_num').value == "예)PKR000249650" || $('post_num').value == "예)1Z04845XYN48937807")
// {
// $('post_num').value = "";
// }
// };
...
<dt class="tit">업체명</dt>
<dd class="cont">
<select id="deleiery_id" name="deleiery_id" class="select_box">
...
<dd class="cont">
<input id="post_num" type="text" class="inp_txt" style="width:130px" name="post_num" placeholder="예)1234567890" onfocus='focusDeleveryNum();'>
...
// }
	function kocnSubmit(){
		var post_num = daum.$("post_num").value;
		var deleiery_id = daum.$("deleiery_id").value;
		if ( deleiery_id === "0" || post_num == "" || post_num.startWith("예)") || post_num.startWith("11자리") ) {
		alert('업체명과 송장번호를 확인해주세요.');
		return false;
		}
		var cpName = deleiery_id[kocn_1][2].cpName;
		post_num = post_num.replaceAll('-','');
		var url = deleiery_id[kocn_1][2].url;
